    ...
    <div class="personal_details">
        <div class="container">
            <div class="personal_wapper">
                <form action="?v=Payment" id="regForm" method="post">
                                    ...
                                    <div class="style_radio">
                                        ...
                                        for( $i = 0; $i < sizeof($genders); $i++ ){
                                            if( $loopGender = selectDB("genders","`id` = '{$genders[$i]}' AND `hidden` = '0' AND `status` = '0'") ){
                                                ...
                                                $checked = ( $i == 0 ) ? "checked=''" : "" ;
                                                echo "<div class=\"size_radio\"> <input id=\"us{$i}\" name=\"gender\" type=\"radio\" value='{$loopGender["id"]}' {$checked}> <label for=\"us{$i}\"> {$title} <span> {$subTitle} </span> </label> </input> </div>";
                                            }
                                        }
                                        ?>
                                    </div>
                                    ...
                                    <div class="checkout_wap mt_45">
                                        ...
                                        <div>
                                            <div class="check_inp mt_30">
                                                <input placeholder="Coupon Code" name="voucher" type="text">
