...
if( !isset($_POST) ){
    ...
    $comon_array = array(
        ...
        'success_url'=>"https://targetkw.net/{$_GET["academyURL"]}",
        'error_url'=>"https://targetkw.net/{$_GET["academyURL"]}",
        'notifyURL'=>"https://targetkw.net/{$_GET["academyURL"]}",
        'test_mode'=>0,
        "whitelabled" => 1,
        'CurrencyCode'=>'KWD',			
        'CstFName'=>"{$_POST["fName"]} {$data["mName"]} {$data["lName"]}",			
        'Cstemail'=>"{$AdminSettings[0]["email"]}",
        'CstMobile'=>"{$data["mobile"]}",
